{{-- resources/views/admin/corrections/list.blade.php --}}
@extends('layouts.app')
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                <tr>
                                    ...
                                    <td class="corrections-list-td">
                                        @if (!empty($row['correctionRequestId']))
                                            <a class="corrections-list-detail"
                                                href="{{ route('stamp_correction_request.approve.show', $row['correctionRequestId']) }}">
                                                詳細
                                            </a>
                                        @else
                                            <span class="corrections-list-empty">—</span>
